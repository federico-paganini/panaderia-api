...
| Contact e-mail alias     | `privacidad@lasdeliciaslp.com`, live since 2026-09-16 via forwardemail.net. `/privacy` publishes it as the Ley 18.331 channel, so the domain's `MX` records are now load-bearing |
